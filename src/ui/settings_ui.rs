...
use crate::settings::{
  GeneralGenerationSettings, GenerationMetadataSettings, ObjectGenerationSettings, Settings, WorldGenerationSettings,
};
...
fn render_buttons(world: &mut World, ui: &mut bevy_inspector_egui::egui::Ui) {
  let very_dark = crate::generation::shared::to_colour_32(VERY_DARK);
  let red = crate::generation::shared::to_colour_32(RED);
  ui.horizontal(|ui| {
