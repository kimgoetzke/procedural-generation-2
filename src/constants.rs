...
pub const TILE_SET_LAND_MODERATE_L1_PATH: &str = "tilesets/land-moderate-l1.png";
pub const TILE_SET_LAND_MODERATE_L2_PATH: &str = "tilesets/land-moderate-l2.png";
pub const TILE_SET_LAND_MODERATE_L3_PATH: &str = "tilesets/land-moderate-l3.png";
pub const TILE_SET_LAND_DRY_L1_PATH: &str = "tilesets/land-dry-l1.png";
pub const TILE_SET_LAND_DRY_L2_PATH: &str = "tilesets/land-dry-l2.png";
pub const TILE_SET_LAND_DRY_L3_PATH: &str = "tilesets/land-dry-l3.png";
