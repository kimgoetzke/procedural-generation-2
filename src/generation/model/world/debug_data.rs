...
/// This struct is used to store generation data on [`crate::generation::model::DraftTile`]s which are then converted to
/// [`crate::generation::model::Tile`]s. The idea is that, with this struct, we can still access stats from the terrain
