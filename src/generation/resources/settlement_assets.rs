...
use crate::generation::lib::{Direction, SettlementResources};
use crate::generation::object::lib::{BuildingTemplate, ObjectName};
...
pub(super) struct BuildingComponentRegistry {
